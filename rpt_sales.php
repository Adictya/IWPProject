...
?>
		...
		<li>
			...
			<ul>
				<li><a href="trans_stockinout.php?mode=in" target="_self"></i>Buy</a></li>
				<li>
					<a href="trans_stockinout.php?mode=out" target="_self">Sell</a>
		...
		<li>
			...
			<ul>
				...
				<li>
					<a href="rpt_stockinout.php?mode=in" target="_self">Buying Report</a>

				</li>
				<li><a href="rpt_stockinout.php?mode=out" target="_self">Selling Report</a></li>
			</ul>
		</li>
